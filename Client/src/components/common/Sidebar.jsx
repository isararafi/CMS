    ...
    <div className={`${styles.sidebar} ${isCollapsed ? styles.collapsed : ''}`}>
      <div className={styles.sidebarHeader}>
        <div className={styles.logoContainer}>
          ...
          {!isCollapsed && <h1 className={styles.title}>CMS</h1>}
        </div>
        ...
        <ul>
          <li className={isActive('/dashboard') ? styles.active : ''}>
            <Link to="/student/dashboard">
              ...
              {!isCollapsed && <span className={styles.menuText}>Dashboard</span>}
            </Link>
          </li>
          ...
          <li className={`${styles.hasSubmenu} ${isActive('/courses') ? styles.active : ''}`}>
            ...
            {!isCollapsed && (
              <ul className={`${styles.submenu} ${coursesSubmenuOpen ? styles.visible : ''}`}>
                {/* <li className={isActive('/courses/overview') ? styles.active : ''}>
                  <Link to="/student/courses/overview">
                    <span className={styles.icon}><BookMarked size={18} strokeWidth={1.5} /></span>
                    <span className={styles.menuText}>Overview</span>
                  </Link>
                </li>
                <li className={isActive('/courses/mids') ? styles.active : ''}>
                  <Link to="/student/courses/mids">
                    <span className={styles.icon}><ListChecks size={18} strokeWidth={1.5} /></span>
                    <span className={styles.menuText}>Mids</span>
                  </Link>
                </li> */}
                <li className={isActive('/courses/mids') ? styles.active : ''}>
                  <Link to="/student/courses/mids">
          ...
          <li className={isActive('/registration') ? styles.active : ''}>
            <Link to="/student/registration">
              ...
              {!isCollapsed && <span className={styles.menuText}>Registration</span>}
            </Link>
          </li>
          ...
          <li className={isActive('/result') ? styles.active : ''}>
            <Link to="/student/result">
              ...
              {!isCollapsed && <span className={styles.menuText}>Result</span>}
            </Link>
          </li>
          ...
          <li className={isActive('/fees') ? styles.active : ''}>
            <Link to="/student/fees">
              ...
              {!isCollapsed && <span className={styles.menuText}>Fees</span>}
            </Link>
          </li>
          ...
          <li className={isActive('/assignments') ? styles.active : ''}>
            <Link to="/student/assignments">
              ...
              {!isCollapsed && <span className={styles.menuText}>Assignments</span>}
            </Link>
          </li>
          ...
          <li className={isActive('/settings') ? styles.active : ''}>
            <Link to="/student/settings">
              ...
              {!isCollapsed && <span className={styles.menuText}>Settings</span>}
            </Link>
          </li>
        </ul>
      </div>
